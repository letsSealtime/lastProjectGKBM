...
<body>
	<h1>◎ 완제품입고관리</h1>
	<span>* 모두 기입</span>
	<form method="post" action="p_product_in_out" class="form">
	...
	<!-- 이건 부분조회 -->
	<!-- /searchBySkuCode -->
	<form method="get" action="product_in_out2">
		<table border="1">
			<thead>
				<tr>
					<th>checkbox</th>
	...
	<!-- 그래서 안에 아무것도 안넣음 -->
	<form id="deleteForm" method="post" action="p_product_in_outDelete"></form>
	...
	<div class="pagination">
		...
		<c:if test="${currentPage > 1}">
			<form method="get">
				...
				<input type="hidden" name="sku_code" value="${pioDTO.sku_code}" />
    ...
    if (searchKeyword == "") {
     ...
     function setFormAction(action) {
         ...
         form.action = "p_product_in_outudpateList"; // 예: "insert", "update" 같은 URL로 설정
         form.submit();
     }
